 ...
 * $Revision: 3 $
 * $Date: 20/06/09 9:43a $
 * @brief    M030G Series ADC Driver Source File
 *
 * @note
...
/**
  ...
  * @return  None
  * @note M030G series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
